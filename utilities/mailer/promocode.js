...
exports.sendEmail = (email_address, emailSubject, promoCode, username)=> {
    ...
    var mailOptions = {
        ...
        // text: 'That was easy!'
        html: HTMLMailFormat(username,promoCode)
    };
...
function HTMLMailFormat(username, resetCode ){
    ...
    <table align="center" style="background-image: linear-gradient(to right, #FAF0AA , #FAE024); width:100%; padding: 5x;">
        <thead>
            <th><img src=${logo} alt="logo" height="55px"> <span style="color: #FF48AC; font-size: 40px; vertical-align: top;">Pharmacy Crack</span> </th>
        </thead>
    </table>
    <table align="center" style="width:100%;">
        <tbody>
            <tr><td style="padding-top: 35px; padding-bottom: 10px;"><img src=${thumb} alt="thumbsup"height="80px" style="display: block;margin-left: auto;margin-right: auto;width: 40%;"></td></tr>
            ...
            <tr><td style="text-align: center; font-weight: bold; font-size: 60px; padding-top: 30px;">${promoCode}</td></tr>
